...
public class PeopleRepository {
    public static ArrayList<Person> getPeople(){
        ...
        people.add(new Person("Bob", "Smith", 30, "Kansas", 62000, "Graphic Designer"));
        ...
        people.add(new Person("William", "Perez", 48, "Oregon", 105000, "Physician"));
        ...
        people.add(new Person("Mia", "Lewis", 25, "Kansas", 47000, "Research Analyst"));
        ...
        people.add(new Person("Harper", "Hall", 27, "Kansas", 51000, "Journalist"));
